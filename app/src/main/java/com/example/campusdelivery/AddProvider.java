...
public class AddProvider extends AppCompatActivity {
    ...
    EditText userN, pass, pass2, perName, email,ephone,eaddress;
    TextView l1, l2, l3, l4, l5, l6,l7;

    String user, password, name, Email,Phone,Address,field;
    String URL = Server.ip + "add_provider.php";
    Button reg, cancel;
Spinner stype;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stype = findViewById(R.id.log_type);
    ...
    public void RegOnclick(View view) {
        if (view.getId() == R.id.reg_reg) {
            ...
            field = stype.getSelectedItem().toString();
            ...
            if (Phone.length() != 10 || !Phone.startsWith("05")) {
                ...
                l7.setText(" * Enter valid Address");
    ...
    private void Registration() {
        class RegAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(AddProvider.this, getResources().getString(R.string.wait), getResources().getString(R.string.connecting));
            }
